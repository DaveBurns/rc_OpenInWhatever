...
_G.OpenInWhateverObjectFactory = require( 'OpenInWhateverObjectFactory' )    -- class of object used to create objects of classes not mandated by the framework.
_G.objectFactory = OpenInWhateverObjectFactory:new()               -- object used to create objects of classes not mandated by the framework.
...
_G.OpenInWhateverManager = require( "OpenInWhateverManager" )
_G.OpenInWhatever = require( "OpenInWhatever" )
_G.openIn = OpenInWhatever:new{ numOfItems=10 } -- increase number here for more items.


--   I N I T I A T E   A S Y N C H R O N O U S   I N I T   A N D   B A C K G R O U N D   T A S K
OpenInWhateverManager.initPrefs() -- remember to include all dependent plugin prefs (plugin generator is not helping in this regard, yet)
